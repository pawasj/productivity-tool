          ...
          <table className="w-full text-sm min-w-[960px]">
            <thead className="sticky top-0 z-10">
              <tr className="bg-slate-50 border-b border-slate-200">
                <th className="text-left px-4 py-2.5 text-xs font-semibold text-slate-500 sticky left-0 bg-slate-50 z-20">Type</th>
                <th className="text-left px-4 py-2.5 text-xs font-semibold text-slate-500 sticky left-[72px] bg-slate-50 z-20 min-w-[160px]">Company / Client</th>
                ...
                <th className="text-left px-4 py-2.5 text-xs font-semibold text-slate-500 sticky right-0 bg-slate-50 z-20 shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.06)]">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-50">
              ...
              {rows.map((row, idx) => {
                if (row.kind === "lead") {
                  ...
                  const briefIsComplete = linkedBrief && String(linkedBrief.status || "") === "completed";
                  ...
                  return (
                    <tr key={`lead-${lead.id}`} className="hover:bg-slate-50 transition-colors group">
                      ...
                      <td className="px-4 py-3 sticky left-[72px] bg-white group-hover:bg-slate-50 z-10">
                      ...
                      <td className="px-4 py-3 sticky right-0 bg-white group-hover:bg-slate-50 z-10 shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.06)]">
                        <div className="flex items-center gap-1 flex-wrap">
                          {linkedBrief ? (
                            <>
                              <button
                                onClick={() => openBriefInDistro(String(linkedBrief.id))}
                              ...
                              {!briefIsComplete && briefHasPlan && (
                                <button
                                  onClick={async () => {
                                    ...
                                    setBriefs(prev => prev.map(b => String(b.id) === String(linkedBrief.id) ? { ...b, status: "completed" } : b));
                              ...
                              {briefIsComplete && (
                                <button
                                  onClick={() => router.push(`/dashboard/results?brief=${linkedBrief.id}`)}
                ...
                return (
                  <tr key={`brief-${brief.id}`} className="hover:bg-violet-50/30 transition-colors group">
                    <td className="px-4 py-3 sticky left-0 bg-white group-hover:bg-violet-50/30 z-10">
                    ...
                    <td className="px-4 py-3 sticky left-[72px] bg-white group-hover:bg-violet-50/30 z-10">
                    ...
                    <td className="px-4 py-3 sticky right-0 bg-white group-hover:bg-violet-50/30 z-10 shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.06)]">
